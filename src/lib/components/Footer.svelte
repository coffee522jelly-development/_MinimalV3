  ...
  <div class="container py-12">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      <div class="col-span-1 md:col-span-2">
        <h3 class="text-lg font-bold mb-4">{settings?.logo_text || window.wpData?.siteName || "Minimal Engineer"}</h3>
        <p class="text-sm text-muted-foreground">© {currentYear} {settings?.logo_text || window.wpData?.siteName || "Minimal Engineer"}.</p>
      </div>
