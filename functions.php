...
function minimal_engineer_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_setting( 'me_enable_page_transition', array( 'default' => true, 'transport' => 'refresh' ) );
    $wp_customize->add_control( 'me_enable_page_transition', array( 'label' => $is_ja ? 'ページ遷移アニメーションを有効にする' : 'Enable Page Transition Animation', 'section' => 'me_layout', 'type' => 'checkbox' ) );
    ...
    register_rest_route( 'me/v1', '/settings', array(
        ...
        'callback' => function() {
            ...
            return array(
                ...
                'enable_page_transition' => (bool) get_theme_mod( 'me_enable_page_transition', true ),
